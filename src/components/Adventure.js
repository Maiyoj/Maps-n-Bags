function Adventure(){
  return (
    <>
    <div className="about">
    <img src={process.env.PUBLIC_URL + '/images/kijiji pictures-2299-2.jpg'} alt="Valentine"></img>
    <p>Hey, I'm Ciara! I'm a 20 something who is passionate about living an adventurous life and helping others to do the same. After working in corporate Human Resources for nearly 2 years, I recently quit my job to travel full time and document my experience along the way. I created this blog to share my travel photos, tips, thoughts, and stories with you!
